...
|23|[Merge k Sorted Lists](https://github.com/ly16/LC-Practice/blob/master/Merge%20K%20Sorted%20Lists.java)|Hard|3 methods: merge in order/ heap/ merge two by two (Linked list)|
...
|112|[Path Sum](https://github.com/ly16/LC-Practice/blob/master/Path%20Sum.java)|Easy|reduced the current node.val (DFS)|
...
|231|[Power of Two](https://github.com/ly16/LC-Practice/blob/master/Power%20Of%20Two.java)|Easy|n&(n-1) trick (math)|
...
|253|[Meeting Rooms II](https://github.com/ly16/LC-Practice/blob/master/Meeting%20Rooms%20II.java)|Medium|like 252, but add a minheap to control the end and merge intersections (sort)|
...
|263|[Ugly Number](https://github.com/ly16/LC-Practice/blob/master/Ugly%20Number.%20java)|Easy|divided by 2,3,5 repeatedly (math)|
...
|350|[Intersection of Two Arrays II](https://github.com/ly16/LC-Practice/blob/master/Intersection%20of%20Two%20Arrays%20II.java)|Easy|if sorted use two pointers (hashmap)|
